The daily award for most philosophical code goes to the author of this elegant way to check that a pair of boolean variables are not equal to each other:
