I regularly hear the take: one request more, one request less - it doesn’t matter. Like, the main thing is that the request must be cheap: it doesn’t read too much, gets into the index, and so on.
